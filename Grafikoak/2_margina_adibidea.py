...
plt.plot(x, y3, label = 'Margin txikia', linestyle = "dotted", alpha = 1, c = "tab:blue")
plt.plot(x, y4, label = 'Margin txikia', linestyle = "dotted", alpha = 1, c = "tab:blue")
plt.plot(x, y5, label = 'Margin txikia', linestyle = "dotted", alpha = 1, c = "tab:orange")
plt.plot(x, y6, label = 'Margin txikia', linestyle = "dotted", alpha = 1, c = "tab:orange")
...
l =plt.legend(handles = [hiper_1, hiper_2] ,fontsize = 10, loc = 'lower left')
